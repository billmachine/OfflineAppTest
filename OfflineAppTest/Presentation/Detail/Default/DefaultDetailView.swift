...
class DefaultDetailView: UIViewController {
    static let identifier = String(describing: DefaultDetailView.self)
    ...
    @IBOutlet weak var txtDesc: ExpandableLabel!
...
extension DefaultDetailView {
    ...
    func fill(game:GameDomain?) {
        ...
        self.txtTitle.text = game?.name
        self.txtDesc.text = game?.descriptionraw ?? ""
